...
var GeoDocumentSnapshot = /** @class */ (function () {
    ...
    GeoDocumentSnapshot.prototype.get = function (fieldPath, options) {
        ...
        return this._isWeb && options
            ? this._snapshot.get(path, options)
    ...
    GeoDocumentSnapshot.prototype.isEqual = function (other) {
        if (other instanceof GeoDocumentSnapshot) {
            return this
                ._snapshot.isEqual(other['_snapshot']);
        }
...
var GeoDocumentReference = /** @class */ (function () {
    ...
    Object.defineProperty(GeoDocumentReference.prototype, "onSnapshot", {
        ...
        get: function () {
            ...
            return function (onNext, onError) {
                return _this
                    ._document.onSnapshot(function (snapshot) { return onNext(new GeoDocumentSnapshot(snapshot)); }, function (error) {
                    if (onError) {
                        onError(error);
                    }
                });
    ...
    GeoDocumentReference.prototype.get = function (options) {
        ...
        return this._isWeb
            ? this._document
                .get(options)
                .then(function (snapshot) { return new GeoDocumentSnapshot(snapshot); })
            : this._document
                .get()
                .then(function (snapshot) { return new GeoDocumentSnapshot(snapshot); });
    };
    ...
    GeoDocumentReference.prototype.isEqual = function (other) {
        if (other instanceof GeoDocumentReference) {
            return this
                ._document.isEqual(other['_document']);
        }
        return this
            ._document.isEqual(other);
    };
    /**
...
var GeoQuerySnapshot = /** @class */ (function () {
    ...
    function GeoQuerySnapshot(_querySnapshot, _center) {
        ...
        this._docs = _querySnapshot.docs.map(function (snapshot) {
            return generateGeoQueryDocumentSnapshot(snapshot, _center);
        });
    }
    ...
    GeoQuerySnapshot.prototype.docChanges = function () {
        ...
        return docChanges.map(function (change) {
            return {
...
var GeoJoinerGet = /** @class */ (function () {
    ...
    function GeoJoinerGet(snapshots, _queryCriteria) {
        ...
        if (this._queryCriteria.limit &&
            ...
            var arrayToLimit = Array.from(this._docs.values())
                .map(function (doc) {
                return {
                    distance: calculateDistance(_this._queryCriteria.center, doc.data().l),
                    id: doc.id,
                };
            })
...
var GeoJoinerOnSnapshot = /** @class */ (function () {
    ...
    GeoJoinerOnSnapshot.prototype._next = function () {
        ...
        if (this._queryCriteria.limit &&
            ...
            for (var i = this._queryCriteria.limit; i < arrayToLimit.length; i++) {
                if (arrayToLimit[i].emitted) {
                    ...
                    var result = {
                        change: __assign({}, arrayToLimit[i].change),
        ...
        this._onNext(new GeoQuerySnapshot({
            docs: docs,
            docChanges: function () {
                return docChanges.reduce(function (reduced, change) {
    ...
    GeoJoinerOnSnapshot.prototype._emit = function () {
        if (this._error) {
            ...
            this._firstRoundResolved =
                this._queriesResolved.reduce(function (a, b) { return a + b; }, 0) ===
    ...
    GeoJoinerOnSnapshot.prototype._processSnapshot = function (snapshot, index) {
        ...
        if (docChanges.length) {
            ...
            docChanges.forEach(function (change) {
                var distance = change.doc.data().l
                    ? calculateDistance(_this._queryCriteria.center, change.doc.data().l)
                    : null;
                ...
                var doc = {
                    ...
                    distance: distance,
                    emitted: _this._firstEmitted ? !!fromMap : false,
                };
                if (_this._queryCriteria.radius >= distance) {
                ...
                else if (!fromMap && !_this._firstRoundResolved) {
...
var GeoQuery = /** @class */ (function () {
        ...
        get: function () {
            ...
            return function (onNext, onError) {
                if (_this._center && _this._radius) {
                    ...
                    var query = _this._limit
                        ? _this._query.limit(_this._limit)
                        : _this._query;
    ...
    GeoQuery.prototype.get = function (options) {
        ...
        if (this._center && typeof this._radius !== 'undefined') {
            var queries = this._generateQuery().map(function (query) {
                return _this._isWeb ? query.get(options) : query.get();
            });
            return Promise.all(queries).then(function (value) {
                return new GeoJoinerGet(value, _this._queryCriteria).getGeoQuerySnapshot();
            });
        }
        else {
            var query = this._limit ? this._query.limit(this._limit) : this._query;
            var promise = this._isWeb
                ? query.get(options)
                : query.get();
...
var GeoCollectionReference = /** @class */ (function (_super) {
    ...
    GeoCollectionReference.prototype.add = function (data, customKey) {
        if (Object.prototype.toString.call(data) === '[object Object]') {
            ...
            var geohash = encodeGeohash(location_1);
            return this._collection
                .add(encodeGeoDocument(location_1, geohash, data))
                .then(function (doc) { return new GeoDocumentReference(doc); });
        }
        else {
            throw new Error('document must be an object');
        }
...
var GeoTransaction = /** @class */ (function () {
    ...
    GeoTransaction.prototype.get = function (documentRef) {
        ...
        return this._transaction
            .get(ref)
            .then(function (snpashot) { return new GeoDocumentSnapshot(snpashot); });
    };
    /**
